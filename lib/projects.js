...
exports.markProjectSeen = function( project , markProjectSeenCallback ) {
    insertRow( 'seen' , project , markProjectSeenCallback );
};
...
exports.overrideProjectDetails = function( project , overrideProjectDetailsCallback ) {
    db.get( 'SELECT * FROM ' + tables.project.name + ' WHERE url = $url' , {
        $url: project.url,
    } , function( err , row ) {
        var field; // iterator
